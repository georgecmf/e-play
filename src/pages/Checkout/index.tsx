    ...
    const form = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            cardOwner: Yup.string().when((values, schema) =>
                 payWithCard ? schema.required('O campo é obrogatório') : schema
            ),
        ...
        {isSuccess && data ? (
            ...
            <>
                ...
                <p className="margin-top">
                    Caso tenha optado pelo pagamento via boleto bancário, lembre-se que a confirmação pode levar até 3 dias úteis.
            ...
            <Card title="Pagamento">
                <>
                    ...
                    <S.Row marginTop="24px">
                        ...
                        <p>
                            Ao optar por essa forma de pagamento, é importante saber que a 
